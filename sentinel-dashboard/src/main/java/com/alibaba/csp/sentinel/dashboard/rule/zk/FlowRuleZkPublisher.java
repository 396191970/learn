...
public class FlowRuleZkPublisher<T> implements DynamicRulePublisher<List<T>> {
    ...
    public void publish(String app, List<T> rules) throws Exception {
        ...
        ZkConfigUtil.setData(app+ZkConfigUtil.FLOW_DATA_ID_POSTFIX, flowRuleEntityEncoder.convert(rules));
    }
